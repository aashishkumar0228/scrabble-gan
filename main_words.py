...
def main():
    ...
    image_base_path = '/home/kaushikdas/aashish/datasets/handwriting/iam_handwriting/words/'
    image_height, _, _ = in_dim
    train_dataset = IAMDbWordsDataLoader(df_base_path, 
                                         image_base_path, 
                                         batch_size, 
                                         char_vec, 
